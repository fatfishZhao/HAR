...
'''
save_dir = '/data3/zyx/project/HAR/trained_model/resnet18_1214_0'
...
data_set = {}
data_set['train'], data_set['val'] = get_train_val_dataset(test_person, transforms=data_transforms,window_size=window_size,overlap=overlap)
dataloader = {}
